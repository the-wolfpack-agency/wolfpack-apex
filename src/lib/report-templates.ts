...
import {
  ...
  genPentestFindings as genEngPentestFindings,
...
const TEMPLATES: ReportTemplate[] = [
  {
    ...
    sections: [
      ...
      { id: "pentest_findings", title: "Penetration Testing", description: "Actively-confirmed vulnerabilities (IDOR, rate limit, info disclosure)", dataSource: "database", generator: genEngPentestFindings },
    ...
    defaultIncluded: ["engagement_summary", "system_map", "security_findings", "pentest_findings", "diagnosed_issues", "work_performed", "scan_coverage", "engagement_recommendations", "recommended_automations"],
  },
  {
