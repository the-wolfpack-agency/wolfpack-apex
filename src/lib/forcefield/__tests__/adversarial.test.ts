...
describe("adversarial self-attack suite", () => {
  ...
  it("covers the core bypass classes (forged/tampered/replay/mandate/auto-block/good-bot/blocklist)", async () => {
    ...
    for (const id of ["forged-principal", "tampered-credential", "replay", "mandate-abuse", "auto-block-fires", "auto-block-spares-client", "good-bot-spared", "blocklist-enforced", "injection-as-data", "expired-credential", "unverifiable-principal", "shadow-mode-honest"]) {
