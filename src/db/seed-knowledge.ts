/**
 * Seed the Wolfpack Apex knowledge base with foundational org knowledge.
...
const KNOWLEDGE: KnowledgeEntry[] = [
  // --- About Wolfpack ---
  {
    ...
    answer: "Wolfpack Agency is a technology company building AI-powered platforms for businesses. We currently operate three products: Wolfpack Apex (team intelligence), Wolfpack Auto (dealer platform), and Wolfpack Learn (e-learning, in development). Our team includes Hoxsie (CEO), Nick (CTO), Max, Jorge, and Meghan.",
    source: "docs",
    tags: ["company", "overview"],
  },
  {
    question: "Who is on the Wolfpack team?",
    answer: "The Wolfpack Agency team consists of 5 members:\n- Hoxsie: CEO, business strategy and client relationships\n- Nick Homyk: CTO, responsible for AI and engineering platform\n- Max: Team member\n- Jorge: Team member\n- Meghan: Team member\n\nEach team member has role-based access to Wolfpack Apex with dashboards tailored to their responsibilities.",
    source: "human",
    tags: ["team", "people"],
  },
  // --- Wolfpack Apex ---
